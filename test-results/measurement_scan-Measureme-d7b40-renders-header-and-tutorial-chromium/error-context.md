...
- Name: measurement_scan.spec.ts >> Measurement Scan E2E >> 02 - Scan entry page renders header and tutorial
- Location: e2e\measurement_scan.spec.ts:184:3
...
Call log:
  - navigating to "http://localhost:3000/client/dashboard/measurements/scan", waiting until "domcontentloaded"
