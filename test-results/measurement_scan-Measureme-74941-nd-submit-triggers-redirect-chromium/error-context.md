...
- Name: measurement_scan.spec.ts >> Measurement Scan E2E >> 05 - Fill entry modal and submit triggers redirect
- Location: e2e\measurement_scan.spec.ts:236:3
...
Call log:
  - navigating to "http://localhost:3000/client/dashboard/measurements/scan", waiting until "networkidle"
...
```ts
  32  |   email: "client@fashionistar.test",
