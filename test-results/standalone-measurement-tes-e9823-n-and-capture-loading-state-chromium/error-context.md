...
- Name: standalone-measurement-test.spec.ts >> Measurement Scan E2E >> 04 - Click Start AI Scan and capture loading state
- Location: e2e\standalone-measurement-test.spec.ts:100:3
...
Locator: getByText('Start AI Scan')
Expected: visible
Timeout: 60000ms
...
Call log:
  ...
  - waiting for getByText('Start AI Scan')
...
- link "Skip to main content":
  - /url: "#main-content"
- complementary:
  - link "Fashionistar Client Portal":
    - /url: /client/dashboard
    - img
    - text: Fashionistar Client Portal
  - img "Avatar for User": C
  - paragraph: client
  - paragraph: client@fashionistar.test
  ...
  - button "Sign out":
    ...
    - text: Sign out
- banner:
  - heading "New AI Scan" [level=1]
  - paragraph: Client Dashboard
  - link "Shop":
    - /url: /
    - img
    - text: Shop
  ...
  - button "Profile menu":
    ...
    - img
- main:
  - text: AI Body Measurement
  - heading "30-Second Body Scan" [level=1]
  - paragraph: Stand in front of your camera in fitted clothing. Our in-house AI captures your 14 key measurements automatically.
  - button "Skip"
  - text: 📱
  - heading "Set Up Your Phone" [level=2]
  - paragraph: Prop your phone at chest height, 1.5–2 metres away. Use a stand or lean it against something stable.
  - button "Next"
  - paragraph: All measurements are processed on our servers. No video is stored or transmitted — only pose landmark coordinates.
