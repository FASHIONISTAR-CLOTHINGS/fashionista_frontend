...
- Name: measurement_scan.spec.ts >> Measurement Scan E2E >> 02 - Navigate to measurement scan page and verify intro
- Location: e2e\measurement_scan.spec.ts:147:3
...
Call log:
  - waiting for locator('text=AI Body Scan') to be visible
