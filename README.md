...
The frontend is deployed as a Docker container on [Hugging Face Spaces](https://huggingface.co/spaces/fashionistar/fashionistar-frontend).

The CI/CD pipeline (`.github/workflows/deploy-hf-frontend.yml`) automatically builds and deploys on every push to `main`.
