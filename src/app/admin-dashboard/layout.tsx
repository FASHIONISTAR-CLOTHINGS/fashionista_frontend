      ...
      >
        ...
        <nav className="px-10 py-[30px] flex flex-col justify-between h-[86%] ">
          <div className="flex flex-col gap-9">
            ...
            <Link
              href="/admin-dashboard/support/sla"
              className={`text-xl leading-[27px] font-medium font-satoshi  flex items-center gap-4 ${
                pathname.includes("/support/sla") ? "text-[#fda600]" : "text-[#bbb]"
              }`}
            >
              <svg
                width="23"
            ...
            <Link
              ...
              className={`text-xl leading-[27px] font-medium font-satoshi  flex items-center gap-4 ${
                pathname.includes("/audit") ? "text-[#fda600]" : "text-[#bbb]"
              }`}
            >
              <svg
                width="23"
              ...
              >
                <path
                  d="M9 12H15M9 16H12M7 4H4C2.89543 4 2 4.89543 2 6V20C2 21.1046 2.89543 22 4 22H20C21.1046 22 22 21.1046 22 20V6C22 4.89543 21.1046 4 20 4H17M7 4C7 3.44772 7.44772 3 8 3H16C16.5523 3 17 3.44772 17 4M7 4C7 4.55228 7.44772 5 8 5H16C16.5523 5 17 4.55228 17 4"
                  stroke="currentColor"
                  strokeWidth="1.5"
                  strokeLinecap="round"
                  strokeLinejoin="round"
