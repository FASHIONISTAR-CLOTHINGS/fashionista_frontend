/**
 * app/admin-dashboard/kyc/page.tsx
 *
 * Server Component shell rendering the KycDashboard client component.
 * Features strict Client-Server boundary isolation and URL state prefetching.
 */

import { Suspense } from "react";
import type { Metadata } from "next";
import { KycDashboard } from "@/features/admin-dashboard";
import { TableRowSkeleton } from "@/shared/components/skeletons";

export const metadata: Metadata = {
  title: "KYC Verification — Fashionistar Admin",
  description: "Review legal identifications, verify tailor status credentials, and run compliance audits.",
};
