  ...
  return (
    <div className="space-y-10 bg-inherit min-h-screen pb-12 font-satoshi text-black">
      ...
      <div className="w-full bg-[#F8F5ED]/40 border border-[#ECE6D6] rounded-[32px] p-6 md:p-8 space-y-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-center font-satoshi">
        ...
        {/* Directory Grid */}
        {isLoading ? (
          <div className="flex flex-col items-center justify-center py-20 gap-3 font-satoshi">
            <Loader2 className="w-8 h-8 text-[#01454A] animate-spin" />
            <p className="text-xs text-[#5A6465]">Loading custom bespoke orders...</p>
          </div>
        ) : isError ? (
          <div className="text-center py-20 border border-dashed border-[#ECE6D6] rounded-[24px] bg-white font-satoshi">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 font-satoshi">
            {orders.map((order) => (
              <div
                key={order.id}
              ...
              >
                ...
                <div className="flex items-center justify-between pt-4 mt-4 border-t border-[#ECE6D6]/50 text-[10px] text-[#8A9596]">
                  ...
                  <button
                    ...
                    className="flex items-center gap-1 font-bold text-xs text-[#01454A] hover:text-[#FDA600] transition cursor-pointer"
                  >
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-3 bg-white border border-[#ECE6D6] rounded-2xl p-5 text-sm">
                    ...
                    <textarea
                      ...
                      className="w-full h-16 p-2 border border-[#ECE6D6] rounded-xl text-xs outline-none focus:border-[#01454A] resize-none text-black bg-white"
                    />
                    <div className="flex gap-2">
                      <button
                        onClick={() => handleUpdateStatus("completed")}
                        disabled={statusMutation.isPending || selectedOrder.status === "completed"}
                        className="flex-1 h-9 bg-[#01454A] text-white text-xs font-bold rounded-xl flex items-center justify-center gap-1.5 disabled:opacity-50 transition cursor-pointer"
                      >
                      ...
                      <button
                        ...
                        className="flex-1 h-9 bg-red-50 hover:bg-red-100 text-red-650 text-xs font-bold rounded-xl flex items-center justify-center gap-1.5 disabled:opacity-50 transition border border-red-200 cursor-pointer"
                      >
                        Cancel Contract
                      </button>
                    </div>
...
export default CustomOrdersDashboard;
