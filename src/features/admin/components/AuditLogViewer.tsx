 ...
 *
 * Features:
 *   - Category filter tabs (financial, support, kyc, auth, general)
 *   - Actor email + resource type search
 *   - Paginated table with old/new value diff viewer
 *   - IP address + user agent display
 *   - Retention policy badge per category
 *
 * Routing: /admin-dashboard/audit
...
import type { AuditCategory, AuditLogEntry, AuditLogFilters } from "../types/audit-log.types";
